...
/**
 * Generates a set of box-shadows with tweaked properties.
 * @note I tend to include something like this to make shadows softer, as an aesthetic
 *   preference. Softer shadows are a great way to add a touch of class.
 */
